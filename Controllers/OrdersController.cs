...
namespace BakeryWebsite.Controllers
{
    public class OrdersController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ordersID,productID,ordQuantity,ordDate,ordDescription")] Orders orders)
        {
        ...
        {
            return _context.Order.Any(e => e.ordersID == id);
        }
    }
}
